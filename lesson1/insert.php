...
if (isset($_POST['submit'])) {
    ...
    $image = "http://192.168.1.3:3456/uploads/" . $fileName;
    // bắt lỗi form
    // if (empty($name)) {
    ...
    // $image = "https://2sao.vietnamnetjsc.vn/images/2017/03/18/19/21/2.jpg";
                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="insert.php" method="post" enctype="multipart/form-data" id="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img id="image_display" src="" width="150" />
                                        </div>
                                        <div class="mb-3 mt-3">
