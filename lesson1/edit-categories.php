...
if (isset($_POST['submit'])) {
    ...
    try {
        ...
        $product = $dbConn->query("SELECT id, name, image FROM categories where id=$id");
                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="edit-categories.php?id=<?php echo $id; ?>" method="post" id="form" enctype="multipart/form-data">
                                        <input value="<?php echo $id; ?>" type="hidden" name="id">
                                        <div class="form-group">
                                            <label style="color: white;" for="name">Tên danh mục</label>
