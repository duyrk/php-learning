                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href='insert-categories.php' class='btn btn-primary'>Thêm mới</a>
                                    </p>
                                        ...
                                        <table class="table table-dark">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                                    echo "<tr>";
                                                    echo "<td>" . $row['name'] . "</td>";
                                                    echo "<td> <img class='img-custom' src='" . $row['image'] . "' width='100' height='500' /> </td>";
                                                    echo "<td>
                        <a href='edit-categories.php?id=" . $row['id'] . "' class='btn btn-primary'>Sửa</a>
...
<script>
    const confirmDelete = (id) => {
        swal({
                ...
                text: "Sau khi xóa, không thể khôi phục được!",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
            .then((willDelete) => {
                if (willDelete) {
                    window.location.href = "delete-categories.php?id=" + id;
                } else {
