                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="edit.php?id=<?php echo $id; ?>" method="post" id="form" enctype="multipart/form-data">
                                        <input value="<?php echo $id; ?>" type="hidden" name="id">
                                        <div class="form-group">
                                            <label style="color: white;" for="name">Tên sản phẩm</label>
                                            <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="<?php echo $name; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label style="color: white;" for="price">Giá sản phẩm</label>
                                            <input type="number" class="form-control" id="price" name="price" placeholder="Enter price" value="<?php echo $price; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label style="color: white;" for="quantity">Số lượng</label>
                                            <input type="number" class="form-control" id="quantity" name="quantity" placeholder="Enter price" value="<?php echo $price; ?>">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <img id="image_display" src="<?php echo $image; ?>" width="150" />
                                        </div>
                                        <div class="mb-3 mt-3">
                                            <label for="categoryId">Danh mục:</label>
                                            <select class="form-control" id="categoryId" name="categoryId" style="color: white;">
                                                <?php
